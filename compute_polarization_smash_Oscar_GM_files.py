...
#we decide to count also the Lambdas within pT and y for which we don't have vorticity data
print_all=True
...
while(True):
    ...
    for line in it:
        ...
        t,x,y,z,px,py,pz=indata[:]
        Ep=math.sqrt(m**2+px**2+py**2+pz**2)
